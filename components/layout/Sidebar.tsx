...
import {
  ...
  Settings2, Building2, ChevronDown, LogOut,
} from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-60 flex-col bg-[#1e3a5f] text-white">
      {/* Logo */}
      ...
      <div className="border-t border-white/10 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="min-w-0">
            ...
            <p className="text-xs text-white/50">{user?.is_staff ? 'Admin' : 'Coordinator'}</p>
          </div>
          <button
            onClick={logout}
